...
const char* ssid     = "PID-2.4";     // WiFi SSID to connect to
const char* password = "pidanalyzer1"; // WiFi password needed for the SSID

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "14bc5f09dd00784045e32fd6d55f498b";                      // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String City             = "BOSTON";                      // Your home city See: http://bulk.openweathermap.org/sample/
